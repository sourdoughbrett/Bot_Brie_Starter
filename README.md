...
- **Multiple Timeframes** for flexible strategy implementation (e.g., 1m, 15m, daily bars).
- **Heikin Ashi Bars** for flexible strategy implementation (e.g., 1m, 15m, daily bars).
